...
from representations.grufusion.back_project import back_project

# from models.modules import SPVCNN
from representations.grufusion.modules import SPVCNN
...
from representations.sparse_voxel_grid import generate_grid
...
class NeuConNet(nn.Module):
    ...
    @staticmethod
    def compute_loss(tsdf, occ, tsdf_target, occ_target, loss_weight=(1, 1), mask=None, pos_weight=1.0):
        """
